            ...
            <div class="modal-dialog register-modal" role="document">
                 <div class="modal-content">
                      ...
                      <div class="modal-body login-body">
                           ...
                           <div class="mb-4">
                                <input type="text" placeholder="Enter Email/Mobile Number" name="register_email_mobile_no" id="register_email_mobile_no" class="form-control">
                           </div>
                           <div class="login-btn">
            ...
            <div class="modal-dialog register-modal" role="document">
                 <div class="modal-content">
                      ...
                      <div class="modal-body login-body">
                           ...
                           <div class="mb-4">
                                <input type="text" name="otpnumber" id="otpnumber" placeholder="Enter OTP Number" class="form-control">
                           </div>
                           <div class="login-btn">
                                {{-- <button type="submit" class="login-submit" id="proceed" data-toggle="modal" data-target="#proceedModal">Verify NUmber</button> --}}
                                <button class="login-submit" onclick="return User_otp_verification()">Verify NUmber</button>
                           </div>
                           <div class="mb-4 member">
     ...
     <div class="pg-footer">
        <footer class="footer">
             ...
             <!--               <a class="footer-copyright-link" href="#" target="_self"> ©2020. | Designed By: Suraj-->
             <!--                    Banerjee.-->
                ...
                $.ajax({
                    ...
                    success: (response) => {
                         if(response == "Invalid entry"){
                            ...
                            var hiddenmobileno = "<input type='hidden' id='mobileoremail' name='mobileoremail' value='"+email_or_mobileno+"'>";

                            $(".otpmodeltitle").html("Please enter the OTP you've received on "+email_or_mobileno+''+hiddenmobileno);
