...
<style>
    ...
    .color_5 {
        background-color: #f765be;
    }
    .color_6 {
        background-color: #87d81b;
        position: relative;
        margin-top: -95px;
    }
    .step_form_sec {
    ...
    <div class="interior-banner-slider owl-carousel owl-theme">
        ...
        <div class="item banner-item">
            ...
            <div class="banner-item-info">
                ...
                <h1 style="color:white">Office</h1>

                <p style="color:white">In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before the final copy is available.</p>
...
<!-- <section>
    ...
    <div class="container">
        ...
        <div class="interior-heading-title">
...
<!-- content area starts -->
 ...
 <section class="step_form_sec " style="margin-top: 50px;">

      <div class="container">

           <div class="step_icon_row row_1">

                <a href="architecture.html" class="step_icon_box_1 color_1">
                ...
                <a href="hvac-consultation.html" class="step_icon_box_1 color_2">
                ...
                <a href="design-consultation.html" class="step_icon_box_1 color_3">
           ...
           <div class="step_icon_row">
                ...
                <a href="electrical-consultation.html" class="step_icon_box_1 color_4">
                ...
                <a href="contractor.html" class="step_icon_box_1 color_5">
                ...
                <a href="structural-consultation.html" class="step_icon_box_1 color_6">
           ...
           <img src="images/Minimalism-03.webp" class="step_icon_div_1">
...
<section class="services_section">
    ...
    <div class="container">
        ...
        <!--    <p>A general term to describe buildings and other physical structures. The art and science of designing buildings and (some) nonbuilding structures.</p>-->
    ...
    <div class="container-fluid">
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-md-4 col-12">
                <img src="images/nk1.jpg" class="design_section_img_1">
                <p class="design_section_p_1">Step 1. Meet Your Designer</p>
            </div>
            <div class="col-lg-3 col-md-4 col-12">
                <img src="images/nk2.jpg" class="design_section_img_1">
                <p class="design_section_p_1">Step 2. Walkthrough of HomeLane Studio</p>
            </div>
            <div class="col-lg-3 col-md-4 col-12">
                <img src="images/nk3.jpg" class="design_section_img_1">
                <p class="design_section_p_1">Step 3. Free Personalised 3D Designs on SpaceCraft Pro</p>
            </div>
            <div class="col-lg-3 col-md-4 col-12">
                <img src="images/nk4.jpg" class="design_section_img_1">
                <p class="design_section_p_1">Step 4. Get an Instant Quote</p>
            </div>
        </div>
                                                    ...
                                                    <ul class="select_buttons">
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select" for="item_3">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/smarthome.png"
                                                                        alt="">
                                                                </div>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select" for="item_5">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/living-room.png"
                                                                        alt="">
                                                                </div>
                                                                <h3>Living Room</h3>
                                                            </label>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select" for="item_9">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/dining-table.png"
                                                                        alt="">
                                                                </div>
                                                                <h3>Dining room</h3>
                                                            </label>
                                            ...
                                            <div class="col-lg-6 col-sm-12 ">
                                                <div class="box  ">
                                                    ...
                                                    <div class="testi">
                                                        ...
                                                        <p class="white-p">"Reference site about Lorem Ipsum, giving information on its
