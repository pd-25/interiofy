            ...
            <div class="step well">
                ...
                <fieldset>
                    <div class="row justify-content-center">
                        <div class="col-sm-12 text-center">
                            <div class="heading">
                                <h2>give us your Office requirements</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="wrapper1">
                                <div class="main_tab">
                                    <div class="tab-wrapper">
                                        <ul class="tabs">
                                            <li class="tab-link active new_tab" data-tab="1">New Office</li>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-sm-6">
                                                    <form class="gaping" action="#" method="post">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Number of Cabins" required />
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Number of Worksations" required />
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Total Carpet Area (square feet)" required />
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
