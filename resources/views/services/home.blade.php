                ...
                <div class="col-lg-8">
                    ...
                    <div class="stepform">
                                                        ...
                                                        <div class="box" id="partnerBox{{$index+1}}">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6"  style="    padding: 26px 10px;">
                                                                    <h3 style="font-weight: 800;">{{$partner->partner->firm_name}}</h3>
                                                                    <h5>About Us</h5>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="testi">
                                                                ...
                                                                <div class="col text-center selectPartner" data-index="{{$index+1}}"> <button class="sert">Select Now</button></div>
                        ...
                        <div class="buttonsGroups button-bg">
                            ...
                            <button class="action submit btn btn-success" onClick="saveBookingData()">Book Your Service</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function saveBookingData(){
        var bookingID = "ServiceID"+generateRandom8DigitNumber();
    ...
    $(document).on("click",".selectPartner",function(){
        ...
        $('.box').each(function () {
            // Remove the specificClassToRemove from each element
