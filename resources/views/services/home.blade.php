            ...
            <div class="col-lg-8">
                ...
                <div class="stepform">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="mobile_code" class="mobile_no form-control"
                                                    placeholder="Phone Number" name="name" onkeypress="New_user_registration_otp_generate()">
                                            </div>
                                                    ...
                                                    <ul class="select_buttons">
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                ...
                                                                <div class="icon">
                                                                    <img class="img-fluid"
                                                                        src="images/living-room.png" alt="">
                                                                </div>
                                                                <h3>Living Room</h3>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                for="item_6">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/kitchen.png"
                                                                        alt="">
                                                                </div>
                                                                <h3>Kitchen</h3>
                                                            </label>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                for="item_8">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/balcony.png"
                                                                        alt="">
                                                                </div>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                ...
                                                                <div class="icon">
                                                                    <img class="img-fluid"
                                                                        src="images/dining-table.png" alt="">
                                                                </div>
                                                                <h3>Dining room</h3>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <ul class="select_buttons">
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                for="item_4">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/bedroom.png"
                                                                        alt="">
                                                                </div>
                                                                <h3>Bedroom</h3>
                                                            </label>
                                                        ...
                                                        <div class="select">
                                                            ...
                                                            <label class="btn btn-warning button_select"
                                                                for="item_7">
                                                                <div class="icon">
                                                                    <img class="img-fluid" src="images/bathroom.png"
                                                                        alt="">
                                                                </div>
                                                                <h3>bathroom</h3>
                                                            </label>
                                    ...
                                    <form class="gaping" action="#" method="post">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control"
                                                        placeholder="Budget (in lakh)" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="box" id="partnerBox{{ $index + 1 }}">
                                                        ...
                                                        <div class="col text-center selectPartner"
                                                            data-index="{{ $index + 1 }}"> <button
                                                                class="sert">Select Now</button></div>
                    ...
                    <div class="buttonsGroups button-bg">
                        ...
                        <button class="action submit btn btn-success" onClick="saveBookingData()">Book Your
                            Service</button>
                    </div>
                </div>
            </div>
