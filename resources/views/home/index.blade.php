...
<section class="step_form_sec " style="padding-bottom: 70px; background: #cccccc;">
     <div class="container">
          <div class="row justify-content-center">
               <div class="col-sm-12 text-center">
                    <div class="heading">
         ...
         <div class="row">
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1 text-center">
                     <a href="#" class="step_icon_box_1 color_1 circle_1">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk1.jpg') }}" class="design_section_img_1 img_flud">
                         </div>
                         <p class="step_name text-black">Share details</p>
                     </a>
                 </div>
             </div>
             <div class="col-lg-1 col-md-2 col-12 coll arrow1">
             ...
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1">
                     <a href="#" class="step_icon_box_1 color_2 circle_2 text-center">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk2.jpg') }}" class="design_section_img_1 img_flud">
                         </div>
                         <p class="step_name">Share Requirement</p>
                     </a>
                 </div>
             </div>
             <div class="col-lg-1 col-md-2 col-12 coll arrow1">
             ...
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1">
                     <a href="#" class="step_icon_box_1 color_3 circle_3 text-center">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk3.jpg') }}" class="design_section_img_1 img_flud">
                         </div>
                         <p class="step_name">We share 3 partners based on your requirement & location</p>
                     </a>
                 </div>
             </div>
             <div class="col-lg-1 col-md-3 col-sm-12 p-0"></div>
         ...
         <div class="row">
             ...
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1">
                     <a href="#" class="step_icon_box_1 color_4 circle_4 text-center">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk4.jpg') }}" class="design_section_img_1">
                         </div>
             ...
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1">
                     <a href="#" class="step_icon_box_1 color_5 circle_5 text-center">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk4.jpg') }}" class="design_section_img_1">
                         </div>
                         <p class="step_name">Finalize the partner of your choice</p>
                     </a>
                 </div>
             </div>
             <div class="col-lg-1 col-md-2 col-12 coll arrow1">
             ...
             <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                 <div class="circle_div_1 step_icon_row row_1">
                     <a href="#" class="step_icon_box_1 color_6 circle_6 text-center">
                         <div class="step_icon">
                              <img src="{{ asset('images/nk4.jpg') }}" class="design_section_img_1">
                         </div>
                         <p class="step_name">Partner will coordinate with quote for execution </p>
                     </a>
                 </div>
             </div>
         </div>
          ...
          <div class="row justify-content-center">
               <div class="col-sm-12 text-center">
                    <div class="blog_slider owl-carousel owl_navigation">
                         ...
                         <div class="holiday_pack_slide" style="height:470px">
